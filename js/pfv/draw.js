    ...
    function(params,colors) {
        ...
        Draw.prototype.drawSourceIndication = function (svg, name, topY, bottomY) {
            ...
            var txt = svg.text(g, 2, bottomY - this.param.trackHeight +10, shortname, {
                transform: rotStr, fill: 'black', 'fill-opacity':'0.8'
            });
        ...
        Draw.prototype.draw3dFlagForTrack = function(svg, track, y, trackID) {
              ...
              //var g1 = this.getGroup(trackID);


              //svg.text(g, 0, y + this.param.trackHeight - 1, "3D");


// an eye from font awesome...
//1259.8983

        var trnsfrm = "matrix(1,0,0,-1,0,"+(y+this.param.trackHeight)+") scale(0.005)";

        var g1 = svg.group({transform:trnsfrm});

        svg.path(g1,"m 1664,576 q -152,236 -381,353 61,-104 61,-225 0,-185 -131.5,-316.5 "+
